      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return transporter.sendMail({
            from: '" NGUYEN TAN LOC 👻" <nguyenloc02082004@gmail.com>',
            // sender address
            to: dataSend.email,
            // list of receivers
            subject: dataSend.language === 'vi' ? "Thông tin đặt lịch khám bệnh" : "Booking informations",
            // Subject line
                ...
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    return transporter.sendMail({
                      ...
                      to: dataSend.email,
                      // list of receivers
                      subject: dataSend.language === 'vi' ? "Kết quả khám bệnh" : "Result",
                      // Subject line
...
var getBodyEmailAttachment = function getBodyEmailAttachment(dataSend) {
  var result = '';
  if (dataSend.language === 'vi') {
    result = "\n            <h3>Xin ch\xE0o ".concat(dataSend.name, " !</h3>\n            <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC \u0111\xE3 ho\xE0n t\u1EA5t th\u1EE7 t\u1EE5c kh\xE1m b\u1EC7nh.</p>\n            <p>Th\xF4ng tin \u0111\u01A1n thu\u1ED1c/h\xF3a \u0111\u01A1n \u0111\u01B0\u1EE3c g\u1EEDi trong file \u0111\xEDnh k\xE8m.</p>\n            <p><b>Vui l\xF2ng kh\xF4ng tr\u1EA3 l\u1EDDi l\u1EA1i email n\xE0y !</b></p>\n            <div>Xin ch\xE2n th\xE0nh c\u1EA3m \u01A1n.</div>\n        "); // html body
  }
  if (dataSend.language === 'en') {
    result = "\n            <h3>Hi ".concat(dataSend.name, " !</h3>\n            <p>This message is sent to you because of your successfull in seeing doctor. </p>\n            <p>Your prescription info/bill is in attachment file image. </p>\n            <div>  <b>Please don't reply this message !</b></div>\n            <div>Sincerely thanks!</div>\n        "); // html body
  }
  return result;
};
module.exports = {
