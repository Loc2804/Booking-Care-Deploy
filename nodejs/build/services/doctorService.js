...
var checkData = function checkData(data) {
  var arr = ['doctorId', 'selectedProvince', 'selectedPayment', 'nameClinic', 'addressClinic', 'selectedSpecialty'];
  var isValid = true;
  var element = '';
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            resolve({
              errCode: 1,
              message: "Missing parameter : ".concat(obj.element, " ")
            });
            _context3.next = 46;
            break;
          case 6:
...
var getScheduleDoctor = function getScheduleDoctor(doctorId, date) {
  return new Promise( /*#__PURE__*/function () {
...
var getExtraInfoDoctorById = function getExtraInfoDoctorById(id) {
  return new Promise( /*#__PURE__*/function () {
